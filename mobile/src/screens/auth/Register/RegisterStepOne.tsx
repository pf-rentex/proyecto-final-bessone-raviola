      ...
      >
        ...
        <View style={{ flex: 1, justifyContent: 'center'}}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
            <GlassyButton text="Real Estate Agency"
                          onClicked={goNextStep}
                          children={
                            <VectorImage source={require('../../../assets/real_estate.svg')}/>
                          }
            />
            <GlassyButton text="Owner"
                          onClicked={goNextStep}
                          children={
                            <VectorImage source={require('../../../assets/owner.svg')} />
                          }
            />
            <GlassyButton text="Tenant"
                          onClicked={goNextStep}
                          children={
        ...
        <Footer action={() => navigation.navigate('Login')}
