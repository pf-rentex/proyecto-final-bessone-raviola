            ...
            <div id="default-modal" aria-hidden="true"
                ...
                <div className="relative w-auto w-full max-w-5xl p-2 h-full md:h-auto">
                    <div className="bg-white rounded-lg shadow p-4 relative dark:bg-gray-700">
                        ...
                        {/* Header */}
                        <div
                            className="flex items-start sticky top-0 bg-white justify-between p-3 border-b rounded-t dark:border-gray-600">
                        ...
                        {/*Footer*/}
                        <div
                            className="flex flex-col md:flex-row sticky bottom-0 bg-white border-t space-x-2 justify-end content-center items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <span className="text-red-600 cursor-pointer mx-4" onClick={onClose}>Cancelar</span>
                            <div className="w-full md:w-auto">
                                ...
                                >
                                    <RiSendPlane2Fill className="text-alt" color={'#7bf3ff'}/>
                                </CustomButton>
                            </div>
                        </div>
                    </div>
