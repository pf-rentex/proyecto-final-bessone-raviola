  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center text-center mt-7 pl-4">
        ...
        <a href="#" className="text-white pt-0.5 underline">
          Contáctanos
        </a>
        <a href="#" className="text-white pt-0.5 underline">
          Otra cosa
      ...
      <div className="flex flex-col-reverse lg:flex-row">
        ...
        <div className="mx-10">
          ...
          <p className="text-white font-thin text-justify text-xs xl:text-base">
            ...
            delectus assumenda cumque ab quasi esse iure corporis eos? Quae
            similique est corrupti repudiandae iure dolores voluptate quaerat.
            Iusto, adipisci asperiores!
          </p>
        </div>
