...
import { BiDotsVerticalRounded, CgProfile, FaBell } from 'react-icons/all';
    ...
    return (
        <div className="flex flex-col w-full lg:w-6/12 xl:w-4/12 2xl:w-3/12 p-2 relative">
                ...
                >
                    {actions?.map((action) => (
                        ...
                        >
                            ...
                            <div className="bg-white self-end rounded-full p-1">{action.icon}</div>
                        </div>
                    ))}
                </div>
            )}
                ...
                <div className="flex justify-end w-full items-center">
                    {canNotify && (
                        <button className="bg-alt py-1 px-3 rounded flex items-center shadow-md focus:shadow-sm">
                            <span className="font-semibold text-xs text-white px-1">Notificar</span>
            ...
            <div className="flex bg-blue-300 rounded-b-md text-alt py-2 justify-between">
                ...
                <div className="flex flex-1 items-center justify-center cursor-pointer border-l border-r border-gray-600">
                    <CgProfile size={18} />
