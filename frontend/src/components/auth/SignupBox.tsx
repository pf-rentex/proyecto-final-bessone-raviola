...
const SignupBox = ({
    ...
    const isValid = (): boolean => {
        return (
            form.email.length > 0 && form.password.length > 0 && passwordsMatch
        );
    };
                ...
                <form>
                    ...
                    <div className="relative w-full mt-5 mb-3">
                        <input
                            ...
                            name="password"
                            className={`${
                                !passwordsMatch ? 'outline-error' : ''
                            } px-3 py-2 placeholder-gray-500 bg-gray-200 text-gray-700 bg-white rounded text-md font-medium shadow focus:outline-none focus:shadow-outline w-full`}
                    ...
                    <div className="text-center mt-4">
                        ...
                        >
                            {isLoading && error.msg.length === 0 && <Spinner />}
                        </CustomButton>
