...
const Onboarding = (): JSX.Element => {
    ...
    const renderWelcomeMessage = (userType: string) => {
        switch (userType) {
            case 'realEstate':
                return (
                    <h3 className="p-3 text-xs lg:text-base font-semibold text-white">
                        Estas a un paso de poder administrar todos tus
                        inmuebles, sólo
                        <br />
            ...
            case 'owner':
                return (
                    <h3 className="p-3 text-xs lg:text-base font-semibold text-white">
                        Estas a un paso de poder publicar y administrar tus
                        propiedades, sólo
                        <br />
            ...
            case 'tenant':
                return (
                    <h3 className="p-3 text-xs lg:text-base font-semibold text-white">
                        Estas a un paso de encontrar tu hogar ideal, <br /> sólo
                        necesitamos un poco más de información acerca de ti
                    </h3>
                );
            default:
                return (
                    <h3 className="p-3 text-xs lg:text-base font-semibold text-white">
                        Estas a un paso de encontrar tu hogar ideal, sólo
                        necesitamos un poco
                        <br />
    ...
    return (
        <section className="absolute w-full h-full bg-gradient-to-b from-bg-gradient-1 to-bg-gradient-2 overflow-hidden">
            <a
                className="text-md text-blue-900 cursor-pointer px-2 py-3"
                onClick={logout}
            >
                Logout
            </a>
