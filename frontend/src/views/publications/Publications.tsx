...
const Publications = () => {
    ...
    const redirectCreatePrublication = () => {
        navigate('create');
    };
    ...
    return (
        <section className="w-full min-h-screen flex flex-col bg-gradient-to-b from-bg-gradient-5 to-bg-gradient-6 overflow-hidden p-5 sm:p-10 md:p-20">
            <div className="flex justify-between items-center mb-4 space-y-4">
                <h1 className="text-white text-xl md:text-4xl font-semibold ">Mis Publicaciones</h1>
                <div className="flex self-end">
                    <CustomButton text="Agregar" color="alt" callback={redirectCreatePrublication}>
